...
const sectionTransferRoutes = require('#backend/routes/sectionTransferRoutes');
const qualityRoutes = require('#backend/routes/qualityRoutes');
const reworkRoutes = require('#backend/routes/reworkRoutes');
