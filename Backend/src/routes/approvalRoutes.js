...
const { approveProductionLog, rejectProductionLog, approveRework, rejectRework } = require('#backend/controllers/approvalController');
...
router.patch('/batch/:batchId/start', protect, restrictTo('MANAGER'), require('#backend/controllers/approvalController').startBatch);
